      ...
      <>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto" style={{ display: "flex", width: "100%" }}>
            ...
            <Nav.Link style={{ flex: 1, justifyContent: "flex-end" }} onClick={handleSignout} as={Link} to="/">
              sign out
        </Nav.Link>
            <Nav.Link style={{ flex: 1, justifyContent: "flex-end" }} onClick={() => props.toggleSettings(true)}><span className="glyphicon glyphicon-cog" /></Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </>
    );
